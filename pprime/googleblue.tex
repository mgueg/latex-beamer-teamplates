% !TEX program = xelatex
%%% let the 1st line below assigned to xelatex
%%% @author:  WisdomFusion <WisdomFusion@gmailcom>
%%% @version: 1.2
%%% @author : modified <mikael.gueguen@ensma.fr> 
...
\usepackage{graphicx,hyperref,pprime}
\usepackage{xcolor}
\usepackage{braket}
\usepackage{listings}
...
% !TEX program = xelatex
\documentclass[aspectratio=169,UTF-8]{beamer}
...
\begin{tabular}{|c|r|r|}
  \hline
  \multirow{2}*{AA} & \multicolumn{2}{c|}{BB}\\
  \cline{2-3}
                     & CC & DD\\
  \hline
  EE               & 87 & 100\\
...
\end{lstlisting}
    ...
    \begin{column}{.3\textwidth}
        \begin{tabular}{|c|r|r|}
          \hline
          \multirow{2}*{AA} & \multicolumn{2}{c|}{AB}\\
          \cline{2-3}
                             & AA & BB\\
          \hline
          DD              & 87 & 100\\
...
\begin{frame}
  ...
  \colorbox{green}{DDD}
  \quad
  \colorbox{blue}{\textcolor{white}{BBB}}
\end{frame}
...
\begin{frame}
  ...
  \begin{wrapfigure}{r}{0.2\textwidth}
    \begin{figure}[t]
      \centering
      \includegraphics[width=0.1\textwidth]{./figs/mactexlogoX5.png}
    \end{figure}
  \end{wrapfigure}
